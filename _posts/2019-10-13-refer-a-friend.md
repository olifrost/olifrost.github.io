...
Any way you like, as long as there is a link back to this page. You can tag a friend on [Instagram](https://instagram.com/{{ site.author.instagram}}) and [Twitter](https://twitter.com/{{ site.author.twitter }}), or send an [email](mailto:{{ site.author.email }}).
</div>
